...
* __02__ (09/07 Thu): Scientific computing, Monte Carlo method, Random number generation ([Slides](files/MCmethod.pdf), [Ipynb](files/MC_Demo.ipynb)). [Grouping for HW/projects, Software installation]
